...
export default function BoxDeco() {
  // Get the component info from the central file
  const componentInfo = layoutComponents.boxDecoration
    ...
    <div className="layout-component">
      ...
      <div className="component-usage mt-8">
        ...
        <div className="usage-example mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="example-code p-4 text-center rounded bg-black">
            <pre className="text-sm bg-black h-full  text-left text-cyan-300 overflow-x-auto">
