import transitionAnComponents from "./TransitionAnMain"

export default function TransitionTimingFunction() {
  // Get the component info from the central file
  const componentInfo = transitionAnComponents.transitionTimingFunction

  return (
    <div className="transitionAn-component">
