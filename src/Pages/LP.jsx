...
export default function LP() {
  const [windowWidth, setWindowWidth] = useState(1240) // Default width
  const breakpoints = {
    sm: 520,
    md: 738,
    lg: 1024,
              ...
              <div className="max-w-4xl mx-auto">
                <div className="flex flex-col items-center">
                  ...
                  <div className="mx-8 overflow-hidden">
                   <div className="w-full h-full mt-8 bg-gray-900/80 rounded-lg p-4 sm:p-8 overflow-hidden mx-0">
                    <div className="relative">
                        ...
                        {Object.entries(breakpoints).map(([key, width]) => (
                          <button
                            ...
                            className={
                              ...
                              (windowWidth === width ? " bg-purple-500 text-white" : " bg-purple-500/20 text-gray-400 hover:bg-purple-500/30")
                            }
                          >
                            {key}
                          </button>
                      ...
                      >
                        ...
                        <div className="p-4">
                          <div className="grid sm:grid-cols-2 gap-4 max-w-full">
                            <img
                      ...
                      <div className="absolute -bottom-6 right-0 text-xs sm:text-sm text-gray-400">
                        {windowWidth}px (
                        {Object.entries(breakpoints).find(([_, width]) => width === windowWidth)?.[0] || "custom"})
                      </div>
                    </div>
                   </div>
